...
TASK-010 is authorized and implemented
on its review branch. The engine remains provider-neutral; source-specific
generation, benchmark assembly, and external integrations beyond the Circle
